...
$config['tables']['users_groups'] = 'users_groups';
$config['tables']['login_attempts'] = 'login_attempts';
$config['tables']['login_activity'] = 'lead_login_activity';
...
$config['admin_email'] = "sureshatpure@gmail.com"; // Admin Email, admin@example.com
$config['default_group'] = 'members';           // Default group, use name
$config['admin_group'] = 'admin';             // Default administrators group, use name
//$config['identity']                   = 'email';             // A database column which is used to login with
$config['identity'] = 'aliasloginname';             // A database column which is used to login with
...
/*
  ...
  | Default: auth/
 */
$config['email_templates'] = 'admin/email/';
