	  ...
	  $this->db->order_by("order_by");
		...
		foreach ($options as $option) {
			$options_arr[$option->leadstatusid] = $option->leadstatus;
                    ...
                    $data['optionslst'] = $options_arr;
                    $data['optionscrd'] = $this->get_leadcredit_assment();
                    $data['optionslsr'] = $this->get_leadsource();
                    $data['optionscmp'] = $this->get_all_company();
                    $data['optionscnt'] = $this->get_country();
                    $data['optionsinds'] = $this->get_industry();
...
// changed for missing leads - conflict with the customermasterhdr
	...
	lead_dtl.leadstatus,
	lead_dtl.leadsource,
	lead_dtl.lst_name as substatusname
FROM
	(
		SELECT
			leaddetails.leadid,
