...
//				alert("from_date"+from_date);
			...
			function openpopupwindow_ps(branch,values)
			{
				//alert(branch);
				//alert(values);
						window.open(base_url+'dashboard/showleadsdata/'+branch+'/'+values,'_blank', 'width=800,height=500,scrollbars=yes,status=yes,resizable=yes,screenx=300,screeny=100,addressbar=no');
			}
		...
		var theme = 'energyblue';
		  ...
		  sortdirection: 'asc',
		   ...
		   showstatusbar: true,
                statusbarheight: 50,
                 ...
                 columns: [
                  { text: 'Branches', dataField: 'user_branch', width: 110, hidden:false, filterable:false },
                  { text: 'New Leads', dataField: 'new_leads', width: 85, cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
                  ...
                  { text: '1-Met The Customer', dataField: 'met_the_customer', width: 85,cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
                  ...
                  { text: 'Credit Assesment', dataField: 'credit_sssessment', width: 85, cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
                  ...
                  { text: 'Sample Trailer Formalities', dataField: 'sample_trails_formalities', width: 85,cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
									...
									{ text: 'Enquiry Offer Negotiation', dataField: 'enquiry_offer_negotiation', width: 85, cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
                  ...
                  { text: 'Managing And Implementation', dataField: 'managing_and_implementation',width: 85, cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
		 ...
		 { text: 'Expanding And Building Relation', dataField: 'expanding_and_build_relationship',width: 85, cellsalign: 'center',cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
		...
		{ text: 'Total', dataField: 'total', width: 120,cellsalign: 'center', cellsformat: 'n2', aggregates: ['sum'],
									aggregatesrenderer: function (aggregates, column, element) {
									var renderstring = "<div class='jqx-widget-content jqx-widget-content-energyblue' style='float: left; width: 100%; height: 100%; '>";
											$.each(aggregates, function (key, value) {
																					    //  var name = key == 'min' ? 'Min' : 'Max';
		...
		$('#todate').on('valuechanged', function (event) {
         ...
         //   	alert("values "+value);
              ...
              //  alert("from date apply filter "+from_date);
               //  alert("to date apply filter "+to_date);
                ...
                // alert("select date filter value inside applyfilter fn "+sel_datefilter);
                 if((dataFieldbranch.length==0) && (br=='AllBranches'))
                 {
                // 	alert("Please Select the Branch");
                 	 setfiltersAllBranch(br,from_date,to_date);
                // 	return false;
                 }
            ...
            // 	alert("the dataFielduser "+dataFielduser);
             	...
             	sel_datefilter = $('#date_filter').val();
             	  if((sel_datefilter==true) && (datafield==""))
             	{
             		 
             		  $.ajax({
	                  	  url : baseurl + 'dashboard/getadditional_withdate_filter/'+from_date+'/'+to_date,
	                   success : function(){
	                       // i must remove the div
	                     //  alert("success");
	                    //   window.location.href=baseurl + 'dashboard/getdatawithfilter/'+ datafield+'/'+dataFielduser+'/'+from_date+'/'+to_date;
	                    window.location.href=baseurl + 'dashboard/getadditional_withdate_filter/'+from_date+'/'+to_date;
	             ...
	             else if(sel_datefilter ==true)
	             {
				  ...
				  $.ajax({
	                  	url : baseurl + 'dashboard/getadditional_withbranchfilter/'+ datafield+'/'+from_date+'/'+to_date,
	                    
	                   success : function(){
	                       // i must remove the div
	                     //  alert("success");
	                       window.location.href=baseurl + 'dashboard/getadditional_withbranchfilter/'+ datafield+'/'+from_date+'/'+to_date;
	             ...
	             {
	        	     $.ajax({
	                  	url : baseurl + 'dashboard/additionalwithfilter/'+ datafield,
	                   success : function(){
	                       // i must remove the div
	                     //  alert("success");
	                       window.location.href=baseurl + 'dashboard/additionalwithfilter/'+ datafield;
	                    //window.location.href=baseurl + 'dashboard/getdatawithdate_filter/'+ datafield+'/'+dataFielduser+'/'+from_date+'/'+to_date;
...
// End for filters 
//	 setfiltersAllBranch Start
 var setfiltersAllBranch = function (datafield,from_date,to_date) {
             	//alert("set setfilters - from  "+from_date);
             //	alert("setfilters - to  "+to_date);
            // 	alert("select date filter value inside setfilter fn "+sel_datefilter);
            // 	alert("the dataFielduser "+dataFielduser);
             	...
             	{*/
             		  ...
             		  $.ajax({
	                  	  url : baseurl + 'dashboard/genleadsallbranches/'+ datafield+'/'+from_date+'/'+to_date,
	                   success : function(){
	                       // i must remove the div
	                     //  alert("success");
	                    //   window.location.href=baseurl + 'dashboard/getdatawithfilter/'+ datafield+'/'+dataFielduser+'/'+from_date+'/'+to_date;
	                    window.location.href=baseurl + 'dashboard/genleadsallbranches/'+ datafield+'/'+from_date+'/'+to_date;
...
//
		...
		$("#jqxgrid").on('celldoubleclick', function (event)
		{
			...
			var branch = rowid.user_branch;
			openpopupwindow_ps(branch,columnheader);
			var col_value;
			var col_days;
...
/*
	...
	*/		
				...
				verticalDescriptionAlignment:'bottom'
                    ...
                    [
				      ...
				      showGridLines: false
						...
						{ dataField: 'new_leads', displayText: 'New Leads'},
						{ dataField: 'prospect', displayText: '0-Prospect'},
            ...
            var settings1 = {
			title: "No of New leads in Each Branch",
			...
			columnSeriesOverlap: false,
					...
					formatSettings: { sufix: ' - Leads', decimalPlaces: 0 },
						...
						{ 
							dataField: 'new_leads', 
							displayText: 'New Lead Generator',
							labelRadius: 150,
							initialAngle: 270,
							radius: 130,
							centerOffset: 5,
						...
						//		alert(chart_data[itemIndex].toSource());
							var browser = chart_data[itemIndex].user_branch;
							return browser + ": " + value + " New Leads ";
                                        	}
						}
					]	
			    	}
            ...
            function myEventHandler(e) {
                var eventData = '<div><b>There are '+e.elementValue +' Leads which are ' + e.serie.displayText + ' in this Branch<b>  </b></div>';
...
<!-- Third menu -->
						<div class="quickWidget">
							<div class="accordion-heading accordion-toggle quickWidgetHeader" data-target="#Leads_sideBar_LBL_RECENTLY_MODIFIED" data-toggle="collapse" data-parent="#quickWidgets" data-label="LBL_RECENTLY_MODIFIED" data-widget-url="#">
								...
								<a class="quickLinks" href="<?= base_url()?>dashboard/daynoprogress"><h5 class="title widgetTextOverflowEllipsis pull-right" title="Day No Progress">Day No Progress</h5></a>
							<div class="clearfix"></div>						
						</div>
<!-- third menu end-->
<!-- Fourth menu -->
					...
					<span class="btn-toolbar span4">
						<div class="contentHeader row-fluid"  style="width:500px;">
							<span title="Additional Lead Data" class="recordLabel font-x-x-large span12 pushDown">
								<strong>Additional Lead Data</strong>
							</span>
							
						</div>
							<span class="btn-group"><!-- <pre><?php echo"lead_ub_count ".$this->session->userdata['lead_ub_count'];
							 echo"user_leads_count ".$this->session->userdata['user_leads_count'] ?></pre> -->
